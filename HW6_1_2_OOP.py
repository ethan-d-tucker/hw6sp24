...
class ResistorNetwork():
    ...
    def GetResistorByName(self, name):
        ...
        for r in self.Resistors:
            if r.Name == name:
                return r
        # Added as a fallback if the resistor is not found, to prevent the function from returning None
        return Resistor()
    #endregion
...
class Resistor():
    ...
    def __init__(self, R=1.0, i=0.0, name='ab'):
        ...
        """
        self.Resistance = R  # Resistance in Ohms
        self.Current = i  # Current in amps
